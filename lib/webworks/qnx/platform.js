...
module.exports = {
    ...
    objects: {
        ...
        ContactAddress: {
            path: 'cordova/plugin/qnx/ContactAddress'
        },
        ContactField: {
            path: 'cordova/plugin/qnx/ContactField'
        },
        ContactName: {
            path: 'cordova/plugin/qnx/ContactName'
        },
        ContactOrganization: {
            path: 'cordova/plugin/qnx/ContactOrganization'
        }
    },
    merges: {
        navigator: {
            children: {
                contacts: {
                    path: 'cordova/plugin/qnx/contacts'
                }
            }
        }
    }
